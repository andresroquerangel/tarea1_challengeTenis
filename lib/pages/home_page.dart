...
import 'package:tarea1_app_tenis/models/data.dart';
import 'package:tarea1_app_tenis/pages/details_product.dart';
...
class _HomePageProductsState extends State<HomePageProducts> {
  ...
  Color getColor() {
    ...
    if (_currentPage >= 0 && _currentPage < 0.7) {
      color = listProducts[0].listImage[0].color;
    } else if (_currentPage > 0.7 && _currentPage < 1.7) {
      color = listProducts[1].listImage[0].color;
    } else if (_currentPage > 1.7 && _currentPage < 2.7) {
      color = listProducts[2].listImage[0].color;
    }
            ...
            Expanded(
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final listTitle = product.category.split(' ');
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        PageRouteBuilder(
                          pageBuilder: (context, animation, _) {
                            return DetailsProductsPage(product: product);
                          },
                        ),
                      );
                    },
